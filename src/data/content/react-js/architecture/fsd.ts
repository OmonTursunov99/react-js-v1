...
// @feature-sliced/eslint-config — FSD uchun maxsus`,
    ...
    relatedTopics: [
      { techId: 'react-js', sectionId: 'architecture', topicId: 'atomic-design', label: 'Atomic Design (alternativa)' },
      { techId: 'react-js', sectionId: 'architecture', topicId: 'solid-react', label: 'SOLID printsiplari' },
    ],
  }
