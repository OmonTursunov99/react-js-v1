...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  return (
    ...
    relatedTopics: [
      { techId: 'react-js', sectionId: 'routing', topicId: 'navigation-hooks', label: 'useNavigate (redirect)' },
      { techId: 'react-js', sectionId: 'component-patterns', topicId: 'hoc', label: 'HOC (withAuth)' },
    ],
  }
