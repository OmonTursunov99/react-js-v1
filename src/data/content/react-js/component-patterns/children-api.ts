...
function SignupForm() {
  return (
    ...
    relatedTopics: [
      { techId: `react-js`, sectionId: `component-patterns`, topicId: `compound-components`, label: `Compound Components` },
      { techId: `react-js`, sectionId: `component-patterns`, topicId: `composition-vs-inheritance`, label: `Composition` },
      { techId: `react-js`, sectionId: `typescript-react`, topicId: `children-types`, label: `Children tipizatsiyasi` },
    ],
  }
