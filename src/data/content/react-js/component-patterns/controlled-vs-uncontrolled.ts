...
function ProfileForm() {
  ...
  return (
    ...
    relatedTopics: [
      { techId: `react-js`, sectionId: `react-core`, topicId: `use-state`, label: `useState (controlled)` },
      { techId: `react-js`, sectionId: `react-core`, topicId: `use-ref`, label: `useRef (uncontrolled)` },
      { techId: `react-js`, sectionId: `react-core`, topicId: `event-system`, label: `Event System` },
      { techId: `react-js`, sectionId: `theory-questions`, topicId: `controlled-uncontrolled-theory`, label: `Nazariy savol` },
    ],
  }
