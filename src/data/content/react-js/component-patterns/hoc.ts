...
function App() {
  ...
  return (
    ...
    relatedTopics: [
      { techId: `react-js`, sectionId: `component-patterns`, topicId: `render-props`, label: `Render Props (alternativa)` },
      { techId: `react-js`, sectionId: `component-patterns`, topicId: `custom-hooks`, label: `Custom Hooks (zamonaviy alternativa)` },
      { techId: `react-js`, sectionId: `react-core`, topicId: `react-memo`, label: `React.memo (HOC misoli)` },
    ],
  }
