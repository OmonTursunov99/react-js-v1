...
function Settings() {
  ...
  return (
    ...
    relatedTopics: [
      { techId: 'react-js', sectionId: 'state-management', topicId: 'context-api', label: 'Context API pattern' },
      { techId: 'react-js', sectionId: 'theory-questions', topicId: 'props-drilling', label: 'Props Drilling muammosi' },
