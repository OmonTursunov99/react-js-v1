...
function StatusBar() {
  ...
  return (
    ...
    relatedTopics: [
        { techId: 'react-js', sectionId: 'state-management', topicId: 'zustand', label: 'Zustand (ichki ishlatadi)' },
        { techId: 'react-js', sectionId: 'state-management', topicId: 'redux-toolkit', label: 'Redux (ichki ishlatadi)' },
    ],
}
