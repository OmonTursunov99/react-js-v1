...
function App() {
  return (
    ...
    relatedTopics: [
        { techId: 'react-js', sectionId: 'react-core', topicId: 'use-context', label: 'useContext (eski usul)' },
        { techId: 'react-js', sectionId: 'theory-questions', topicId: 'react-18-19', label: 'React 19 yangiliklari' },
        { techId: 'react-js', sectionId: 'component-patterns', topicId: 'suspense-lazy', label: 'Suspense bilan ishlaydi' },
    ],
}
