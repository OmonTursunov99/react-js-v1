...
const [data, setData] = useState({ x: 0, y: 0 }) // { x: number, y: number }`,
    ...
    relatedTopics: [
      { techId: 'react-js', sectionId: 'react-core', topicId: 'batching', label: 'setState Batching' },
      ...
      { techId: 'react-js', sectionId: 'component-patterns', topicId: 'controlled-vs-uncontrolled', label: 'Controlled vs Uncontrolled' },
