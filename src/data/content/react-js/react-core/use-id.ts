...
function RegistrationForm() {
  return (
    ...
    relatedTopics: [
        { techId: 'react-js', sectionId: 'theory-questions', topicId: 'ssr-csr-ssg', label: 'SSR va hydration' },
        { techId: 'react-js', sectionId: 'architecture', topicId: 'accessibility', label: 'Accessibility (aria-*)' },
    ],
}
