...
function App() {
  return (
    ...
    relatedTopics: [
      { techId: 'react-js', sectionId: 'state-management', topicId: 'redux-toolkit', label: `Redux Toolkit (o'xshash pattern)` },
      { techId: 'react-js', sectionId: 'state-management', topicId: 'when-to-use-what', label: 'useState vs useReducer' },
      { techId: 'react-js', sectionId: 'react-core', topicId: 'use-context', label: 'useContext bilan birga' },
    ],
  }
