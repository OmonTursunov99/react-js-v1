...
function ReconciliationDemo() {
  ...
  return (
    ...
    relatedTopics: [
        ...
        { techId: 'react-js', sectionId: 'theory-questions', topicId: 'key-importance', label: 'Key nima uchun kerak' },
        { techId: 'react-js', sectionId: 'theory-questions', topicId: 'virtual-dom-theory', label: 'Nazariy savol' },
    ],
}
