...
function Header() {
  ...
  return (
    ...
    relatedTopics: [
      { techId: 'react-js', sectionId: 'react-core', topicId: 'use-deferred-value', label: 'useDeferredValue (React alternativa)' },
      { techId: 'react-js', sectionId: 'component-patterns', topicId: 'custom-hooks', label: 'useDebounce custom hook' },
    ],
  }
