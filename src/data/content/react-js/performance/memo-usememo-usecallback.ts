...
function SimpleButton() {
  ...
  return <button onClick={() => setCount(c => c + 1)}>{count}</button>
    ...
    relatedTopics: [
      { techId: 'react-js', sectionId: 'react-core', topicId: 'use-memo', label: 'useMemo' },
      { techId: 'react-js', sectionId: 'react-core', topicId: 'use-callback', label: 'useCallback' },
      { techId: 'react-js', sectionId: 'react-core', topicId: 'react-memo', label: 'React.memo' },
