...
function ProductCard({ product }: { product?: Product }) {
  ...
  return (
    ...
    relatedTopics: [
      { techId: 'react-js', sectionId: 'performance', topicId: 'profiler-devtools', label: 'React Profiler' },
      { techId: 'react-js', sectionId: 'performance', topicId: 'code-splitting', label: 'Code Splitting (LCP)' },
      { techId: 'react-js', sectionId: 'theory-questions', topicId: 'ssr-csr-ssg', label: 'SSR (performance)' },
    ],
  }
