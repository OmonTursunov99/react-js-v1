...
// "@rolldown/plugin-babel": "..."`,
    ...
    relatedTopics: [
      { techId: 'react-js', sectionId: 'performance', topicId: 'memo-usememo-usecallback', label: 'useMemo/useCallback (eski usul)' },
      { techId: 'react-js', sectionId: 'react-core', topicId: 'jsx-transform', label: 'JSX Transform' },
