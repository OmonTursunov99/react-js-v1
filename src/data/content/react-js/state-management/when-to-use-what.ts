...
function GoodComponent() {
  ...
  const total = items.reduce((sum, i) => sum + i.price, 0)  // ✅ har doim to'g'ri
    ...
    relatedTopics: [
      { techId: 'react-js', sectionId: 'react-core', topicId: 'use-state', label: 'useState (local)' },
      { techId: 'react-js', sectionId: 'react-core', topicId: 'use-reducer', label: 'useReducer (complex local)' },
      { techId: 'react-js', sectionId: 'state-management', topicId: 'context-api', label: 'Context (shared)' },
      { techId: 'react-js', sectionId: 'state-management', topicId: 'redux-toolkit', label: 'Redux (global)' },
      { techId: 'react-js', sectionId: 'state-management', topicId: 'zustand', label: 'Zustand (lightweight global)' },
      { techId: 'react-js', sectionId: 'state-management', topicId: 'tanstack-query', label: 'TanStack Query (server)' },
    ],
  }
