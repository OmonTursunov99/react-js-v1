...
function InfinitePostList() {
  ...
  return (
    ...
    relatedTopics: [
      { techId: 'react-js', sectionId: 'state-management', topicId: 'tanstack-query', label: 'TanStack Query asoslari' },
      { techId: 'react-js', sectionId: 'react-core', topicId: 'use-optimistic', label: 'useOptimistic (React 19)' },
    ],
  }
