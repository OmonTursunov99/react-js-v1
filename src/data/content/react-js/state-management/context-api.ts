...
function CartProvider({ children }: { children: ReactNode }) {
  ...
  return (
    ...
    relatedTopics: [
      { techId: 'react-js', sectionId: 'react-core', topicId: 'use-context', label: 'useContext hook' },
      { techId: 'react-js', sectionId: 'component-patterns', topicId: 'provider-pattern', label: 'Provider Pattern' },
      { techId: 'react-js', sectionId: 'theory-questions', topicId: 'props-drilling', label: 'Props Drilling yechimi' },
      { techId: 'react-js', sectionId: 'performance', topicId: 're-render-causes', label: 'Context re-render muammosi' },
    ],
  }
