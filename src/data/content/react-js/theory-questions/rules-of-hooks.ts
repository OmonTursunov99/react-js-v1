...
function UserProfile({ userId }: { userId: string | null }) {
  ...
  return <h1>{user?.name}</h1>
    ...
    relatedTopics: [
      { techId: 'react-js', sectionId: 'component-patterns', topicId: 'custom-hooks', label: 'Custom Hooks' },
      { techId: 'react-js', sectionId: 'theory-questions', topicId: 'closures-in-hooks', label: 'Closures in Hooks' },
      { techId: 'react-js', sectionId: 'theory-questions', topicId: 'fiber-architecture', label: 'Fiber (linked list)' },
    ],
  }
